public class MathOperations {
    public static void main(String[] args) {
        ...
        System.out.println(" Originally, Fred had " + (testScore * bonusMarks) + " times more sweets than George ");
        System.out.println(" Andromeda has " + (bagOfSweets2/bagOfSweets1) + " times more stars " );
        System.out.println(" Snape caught the error. Furious, he divided Ron's score to: " + (starsInAndromed/starsInMilkyWay));
        System.out.println(" 10 is an even number, since dividing 10 by 2 has a remainder of:" + (10 % 2));
        System.out.println(" 5 is a odd number, since dividing 5 by 2 has a remainder of:" + (5 % 2));
      int counter = 3;
      counter --;
      counter --;
      counter --;
